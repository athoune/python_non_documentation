...
Il est possible de remonter dans l'historique, pour reprendre une ligne précédente, sans avoir à tout retaper.
...
La link:https://www.numworks.com/fr/simulateur/[calculatrice Numworks fournit un simulateur en ligne]. L'interpréteur interactif est nommé "Console d'exécution".

La plupart des interpréteurs interactifs fournissent de la complétion.
